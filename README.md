...
<p align="center">
  $\vec{p}_r=\vec{f}\left(\left\|\vec{p}_0\right\|, \theta, \varphi\right)=\left[\left\|\vec{p}_0\right\| \sin \theta \cos \varphi \quad\left\|\vec{p}_0\right\| \sin \theta \sin \varphi \quad\left\|\vec{p}_0\right\| \cos \theta\right]^{\top}$
</p>
